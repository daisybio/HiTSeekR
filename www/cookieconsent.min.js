    ...
    if (!t.isInit) {
        var e = {
            getCookie: function (t) {
                ...
                var e = parseInt(this.normalizeColor(t), 16), n = (e >> 16) - 20, i = (e >> 8 & 255) - 20,
                    s = (255 & e) - 20;
        ...
        t.fadeEnd = function () {
            ...
            function r(n) {
                var i = this.options, s = document.createElement("div"),
            ...
            return i.prototype.init = function (i) {
                this.options && this.destroy(), e.extend(this.options = {}, n), e.isPlainObj(i) && e.extend(this.options, i), function () {
                    var t = this.options.onInit.bind(this);
                    if (window.CookiesOK || window.navigator.CookiesOK) return t("dismiss"), !0;
                    var e = this.getStatus(), n = "dismiss" == e;
                    n && t(e);
                    return n
                }.call(this) && (this.options.enabled = !1);
                var s = this.options.container.replace("{{classes}}", function () {
                    var n = this.options, i = "top" == n.position || "bottom" == n.position ? "banner" : "float";
                    e.isMobile() && (i = "float");
                    var s = ["wpcc-" + i];
                    ...
                    (function (n) {
                        var i = e.hashColors(JSON.stringify(n)), s = "wpcc-color-custom-" + i, o = e.isPlainObj(n);
                        this.customCSS = o ? s : null, o && function (e, n, i) {
                            if (t.customCSS[e]) return void ++t.customCSS[e].references;
                            var s = {}, o = n.popup, r = n.button;
                ...
                this.onButtonClick && this.element && (this.element.removeEventListener("click", this.onButtonClick), this.onButtonClick = null), this.onButtonEnter && this.element && (this.element.removeEventListener("keyup", this.onButtonEnter), this.onButtonEnter = null), this.wrapper && this.wrapper.parentNode ? this.wrapper.parentNode.removeChild(this.wrapper) : this.element && this.element.parentNode && this.element.parentNode.removeChild(this.element), this.wrapper = null, this.element = null, function (n) {
                    if (e.isPlainObj(n)) {
                        var i = e.hashColors(JSON.stringify(n)), s = t.customCSS[i];
                        if (s && !--s.references) {
                ...
                if (t.fading && n && (this.afterFading && o.call(this, n), e.hasClass(n, "wpcc-invisible"))) {
                    if (n.style.display = "", this.options.pushdown) {
                        var i = 0, r = this.element.clientHeight;
                ...
                var n = this.options.cookie, i = e.getCookie(n.name);
